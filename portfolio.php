...
$query = "SELECT * FROM home, section_control, social_media, about, contact_details";
    ...
    <div class="container">
      ...
      ?>
        <div class="social-links">
          ...
          <a href="https://twitter.com/<?=$user_data['twitter']?>" class="twitter"  target="_blank"><i class="bi bi-twitter"></i></a>
          <?php  }?>

          <?php if($user_data['facebook']!=''){ ?>
            <a href="https://facebook.com/<?=$user_data['facebook']?>" class="facebook" target="_blank"><i class="bi bi-facebook"></i></a>
          <?php  }?>

          <?php if($user_data['instagram']!=''){ ?>
            <a href="https://instagram.com/<?=$user_data['instagram']?>" class="instagram" target="_blank"><i class="bi bi-instagram"></i></a>
          <?php  }?>

          <?php if($user_data['github']!=''){ ?>
            <a href="https://github.com/<?=$user_data['github']?>" class="github"><i class="bi bi-github" target="_blank"></i></a>
          <?php  }?>       
          
          <?php if($user_data['linkedin']!=''){ ?>
          <a href="https://linkedin.com/<?=$user_data['linkedin']?>" class="linkedin"><i class="bi bi-linkedin" target="_blank"></i></a>
          <?php  }?>   
